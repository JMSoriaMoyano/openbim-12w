# Audit Report · variante comun

> Generado el 2026-06-17T17:25:14.849922+00:00 por el motor `quality_engine 0.2.0-s6x`.
...
| Variante EIR | `comun` |
| Versión EIR | `0.2` |
| Fuente EIR | `comun@0.2` |
| YAMLs usados | `PBSA_v0.2_comun.yaml` |
...
| D2 | Propiedades | 16 | 4 | 11 | 1 | 0 | 25.0% |
...
11. **`C-P-01` (D2):** IDS spec 'C-P-01' FAIL · 0/1 entidades cumplen (0%).
12. **`C-P-02` (D2):** IDS spec 'C-P-02' FAIL · 0/4 entidades cumplen (0%).
13. **`C-P-03` (D2):** IDS spec 'C-P-03' PARTIAL · 3/5 entidades cumplen (60%).
14. **`STR.BSDD.Classification` (D6):** Legacy structural check_bsdd_classification → fail.

---

**Trazabilidad:** este reporte fue generado por `scripts/s6x_generate_e6_outputs.py` a partir de `out/AC20-FZK-Haus_compliance_post_comun_v2.json`. La matriz JSON es la fuente canónica; este Markdown es derivado.
